**What is happening?**
CHG0037739 - MCS GOLD - 2022 Q2 Patching - Preparatory Steps for Openshift Upgrade
CHG0037734 - MCS GOLD - 2022 Q2 Patching - Upgrade to Openshift 4.9

These two changes represent the work involved to upgrade the production GOLD cluster from Openshift 4.8 to 4.9.

**When?**

CHG0037739 will commence at 6:00am PDT on Sunday June 19th 2022.
CHG0037734 will commence at 9:00am PDT on Monday June 20th 2022. Upgrade efforts will be allowed to proceed between 9:00am and 5:00pm, and be paused after-hours to ensure developers are present during node drains to look after their apps if needed.

**Will there be an impact on the Platform apps?**

CHG0037739 will only involve putting the internal registry into read-only mode, thus affecting new images being built to be saved. Existing images can still be accessed and no impact to existing workloads. This update will also involve the NetApp Trident pods, so it is possible automated storage provisioning during this window might delay or fail, but work when attempted again.
